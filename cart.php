...
<body>
    ...
    <!-- Main -->
        ...
        $query = "SELECT items.price AS Price, items.item_id,items.name AS Name FROM users_items JOIN items ON users_items.item_id = items.uid WHERE users_items.user_id='$user_id' and status='Added To Cart'";
